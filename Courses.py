...
sd_course =   [['Python for Everybody Specialization','https://www.coursera.org/specializations/python'],
               ['Coding for Everyone: C and C++ Specialization','https://www.coursera.org/specializations/coding-for-everyone'],
               ['Data Structures and Algorithms, Part I','https://www.coursera.org/learn/algorithms-part1'],
               ['How to Become a Senior Developer - Beyond coding skills','https://www.udemy.com/course/junior-to-senior-software-developer'],
               ['How to become a Successful Software Programming Developer','https://www.udemy.com/course/how-to-become-a-successful-software-programming-developer'],
               ['Software Development From A to Z - Beginners Complete Guide','https://www.udemy.com/course/software-development-from-a-to-z']]

cs_course =   [['The Complete Cyber Security Course : Hackers Exposed!','https://www.udemy.com/course/the-complete-internet-security-privacy-course-volume-1'],
               ...
               ['Google Cybersecurity Professional Certificate','https://www.coursera.org/professional-certificates/google-cybersecurity'],
                ['Introduction to Cybersecurity Fundamentals','https://www.coursera.org/learn/introduction-to-cybersecurity-fundamentals'],
                ['Introduction to Cybersecurity','https://www.netacad.com/courses/cybersecurity/introduction-cybersecurity'],
                ['Certified-ethical-hacker-ceh-certification-international','https://campaigns.eccouncil.org/certified-ethical-hacker-ceh-certification-international?utm_campaign=&gad_source=1']]